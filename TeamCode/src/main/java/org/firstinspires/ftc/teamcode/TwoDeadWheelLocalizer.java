...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2289.0780978779585; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 107.93569242355306; // x position of the perpendicular encoder (in tick units)
    }
